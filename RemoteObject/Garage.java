...
public interface Garage extends Remote{
    ...
    public boolean user_login (String NomUsuari, String contrasenya, int callbackID)  throws RemoteException;
    ...
    public int addCallback (ClientCallbackInterface callbackObject) throws java.rmi.RemoteException;
